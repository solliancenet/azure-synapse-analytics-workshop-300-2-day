...
$secretValueTest = $(Get-AzKeyVaultSecret -VaultName $keyVaultName -Name "SqlPassword").SecretValueText
Write-Information "Secret Value (test): " + $secretValueTest
$global:sqlPassword = $sqlPasswordSecret.SecretValue #| ConvertFrom-SecureString -AsPlainText
